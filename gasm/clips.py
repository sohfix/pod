...
Quick examples:
  ...
  podmix -i INPUT.mp3 --start 3:50.250 --end 4:50.750 --name intro --edge-fade 0.02
...
Single clip:
  ...
  podmix -i INPUT.mp3 --start "3:50.250" --end "4:50.750" --name intro
  podmix -i INPUT.mp3 --start 235.1 --end 300.9 --name funny_bit --edge-fade 0.02
  podmix -i INPUT.mp3 --start 3:55 --end 4:55.500 --name teaser --mono --cbr 192k
...
def parse_batch_file(path: Path) -> Tuple[str, List[dict]]:
    ...
    CSV format:
      ...
      start,end,name,description
      3:55.000,4:55.250,hot_take,#default
      2:35.100,3:33.900,funny_bit,Hosts crack up
      420.0,505.5,,
    """
    default_desc = ""
